...
public class App {
    public static void main(String[] args) {
        ...
        System.out.println("Triangulo 1 - Vertice 1 : " + triangulo1.getV1().toString());
        System.out.println("Triangulo 1 - Vertice 2 : " + triangulo1.getV2().toString());
        System.out.println("Triangulo 1 - Vertice 3 : " + triangulo1.getV3().toString());
